...
\Cref{implicit} combines these simple ingredients to create a reflection-based version of the original GDP example
from \Cref{idioms-fig}. Comparing the two examples side-by-side, the use of reflection with GDP seems to offer a
